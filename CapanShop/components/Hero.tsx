...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative flex min-h-screen items-center overflow-hidden">
      ...
      <div className="container-shop relative z-10 py-32 text-center">
        <div className="mx-auto max-w-3xl rounded-md border border-white/5 bg-ink/60 px-6 py-10 shadow-[0_20px_60px_rgba(0,0,0,0.4)] backdrop-blur-sm sm:px-12">
        ...
        <h1
          className="animate-fadeUp font-display text-4xl leading-tight text-cream-100 sm:text-6xl lg:text-7xl"
        ...
        <p
          className="mx-auto mt-6 max-w-2xl animate-fadeUp text-base text-cream-300 sm:text-lg"
