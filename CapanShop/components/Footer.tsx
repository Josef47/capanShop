    ...
    <footer className="border-t border-gold-400/15 bg-coffee-950 py-12">
      <div className="container-shop flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex gap-6 text-sm text-cream-300">
          <a href={`tel:${SHOP.phone.replace(/\s/g, "")}`} className="transition-colors hover:text-gold-300">
            {SHOP.phoneDisplay}
          </a>
        ...
        <a
          ...
          className="flex items-center gap-2 text-sm text-cream-300 transition-colors hover:text-gold-300"
        >
        ...
        <Link
          href="/admin"
          className="rounded-sm border border-coffee-700 px-4 py-2 text-xs uppercase tracking-widest text-cream-400 transition-colors hover:border-gold-400 hover:text-gold-300"
        >
          {t("nav.admin")} →
        </Link>
