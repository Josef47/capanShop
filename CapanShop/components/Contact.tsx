    ...
    <section id="contact" className="py-24">
      <div className="container-shop">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <Reveal>
            <div className="card flex h-full flex-col gap-6 p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xs font-semibold uppercase tracking-widest text-cream-400">
                    {t("contact.phone")}
                  </h3>
                  <a
                    href={`tel:${SHOP.phone}`}
                    className="block font-display text-xl text-cream-100 transition-colors hover:text-gold-300"
                  >
                    {SHOP.phoneDisplay}
                  </a>
                  <a
              ...
              <div className="mt-2 border-t border-coffee-700/50 pt-5">
                <h3 className="mb-3 text-xs font-semibold uppercase tracking-widest text-cream-400">
                  {t("hours.title")}
                </h3>
          ...
          <Reveal delay={150}>
            {/* Google Maps placeholder — swap for a real embed later */}
            <div className="card group relative flex h-full min-h-[420px] items-center justify-center overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                <span className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border-2 border-gold-400 text-3xl text-gold-400">
                  ⚲
                </span>
