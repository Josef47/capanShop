    ...
    >
      <nav className="container-shop flex h-20 items-center justify-between">
        ...
        <div className="ml-12 hidden items-center gap-4 lg:flex">
          ...
          <a href="#booking" className="btn-gold !px-5 !py-2.5 !text-xs">
            {t("nav.book")}
          </a>
        </div>
      ...
      {/* Mobile menu */}
      <div
        className={`overflow-hidden border-t border-gold-400/10 bg-ink/95 backdrop-blur-md transition-all duration-500 lg:hidden ${
