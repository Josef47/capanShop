      ...
      <div className="container-shop grid items-center gap-12 lg:grid-cols-2">
        ...
        <Reveal delay={150}>
          <div className="card relative overflow-hidden p-8">
            <div className="absolute inset-0 animate-shimmer bg-gradient-to-r from-transparent via-gold-400/5 to-transparent bg-[length:200%_100%]" />
            <div className="relative">
              <div className="flex items-baseline justify-between">
                <h3 className="font-display text-2xl text-gold-300">Capan Club</h3>
                <span className="text-sm text-cream-300">
                  {stamps}/{MAX_STAMPS} {t("loyalty.stamps")}
                </span>
              </div>
